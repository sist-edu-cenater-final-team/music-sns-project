...
public class EumpyoChargeDAO_imple implements EumpyoChargeDAO {
    ...
    public int setUserCoin(long userId, long coin) {
        ...
        p.put("userId", userId);
        p.put("coin", coin);
        return sql.update("eumpyoCharge.setUserCoin", p);
    }
    ...
    public int insertChargeHistory(long userId, int coin, int atThatPrice, long afterBalance) {
        ...
        p.put("userId", userId);
        p.put("coin", coin);
        p.put("atThatPrice", atThatPrice);
        p.put("afterBalance", afterBalance);
        return sql.insert("eumpyoCharge.insertChargeHistory", p);
    }
