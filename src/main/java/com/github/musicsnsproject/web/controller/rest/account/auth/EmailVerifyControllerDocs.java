...
public interface EmailVerifyControllerDocs {
    ...
    CustomSuccessResponse<Boolean> duplicateCheckEmail(@RequestParam @Email(message = "이메일 타입이 아닙니다.") @Parameter(description = "사용자 이메일") String email);
    ...
    CustomSuccessResponse<Void> sendVerifyCodeToEmail(@RequestParam @Email(message = "이메일 타입이 아닙니다.")@Parameter(description = "사용자 이메일") String email);
    ...
    CustomSuccessResponse<Boolean> verifyEmail(@RequestParam @Email(message = "이메일 타입이 아닙니다.")@Parameter(description = "사용자 이메일") String email, @RequestParam @Parameter(description = "메일에 전송된 인증 번호") String code);
